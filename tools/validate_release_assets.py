"""Static release-asset validation for the Mitra Regressor DIMER pipeline.
...
REPO_NAME = "mitra-regressor-pipeline"
EXPECTED_MODEL_ID = "autogluon/mitra-regressor"
...
NOTEBOOKS = {
    "mitra_regressor_colab.ipynb": {
        ...
        "expected_outputs": (
            "outputs/mitra_regressor_input_manifest.json",
            "outputs/mitra_regressor_evaluation_report.json",
            "outputs/mitra_regressor_result.json",
            "outputs/mitra_regressor_predictions.csv",
        ),
        "code_markers": (
            ...
            "LGBMRegressor(random_state=SEED, n_estimators=100, verbose=-1)",
        ...
        "markdown_markers": (
            "**Capability:** end-to-end tabular regression with the pinned `autogluon/mitra-regressor` checkpoint",
    ...
    "mitra_regressor_predictor_inference_colab.ipynb": {
        ...
        "expected_outputs": (
            "outputs/mitra_regressor_predictor_inference_input_manifest.json",
            "outputs/mitra_regressor_predictor_inference_evaluation_report.json",
            "outputs/mitra_regressor_predictor_inference_result.json",
            "outputs/mitra_regressor_predictor_inference_predictions.csv",
        ),
        "code_markers": (
            "ARTIFACT_ZIP_PATH = ''",
            "EXPECTED_ZIP_SHA256 = ''",
